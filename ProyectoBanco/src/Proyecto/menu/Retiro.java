...
public class Retiro extends JFrame implements ActionListener {
    ...
    public void funciones() {
        ...
        eti = new JLabel("Retiro");
        eti.setFont(new Font("Agency FB", Font.BOLD,60));
        eti.setForeground(Color.WHITE);
        eti.setBounds(280, 50, 800, 40);
        
        l4 = new JLabel("Cuanto desea Retirar");
    ...
    public void impTicket() {
        ...
        areaTicket.setText(" Cajero: Banco BANCEX \n\n"
                        ...
                        + "\n\n"
                        + "======================================\n"
                        + "La operacion se realizo por BANCEX\n"
                        + "Te atendio: Julio C. \n\n"
    ...
    public void actionPerformed(ActionEvent presiona) {
        if (presiona.getSource() == b6) {
            if (saldo >= 100) {
                saldo = 100.00;
                monto = 100.00;
                JOptionPane.showMessageDialog(null, "Retiro Exitoso tu saldo es $" + saldo, "Saldo", JOptionPane.INFORMATION_MESSAGE);
